...
The first step (build) this refers to the synchronisation of the source code with relevant updates. This is initiated by the Research Software Engineer: a commit is made to a repository, detailing a change which the RSE 

\begin{description}
  \item[Integration Workf]
\end{description}
